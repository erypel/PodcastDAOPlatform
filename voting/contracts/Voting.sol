...
contract Voting {
	// An event that is called whenever a Candidate is added so the frontend can
	// appropriately display the candidate with the right element ID (it is used
	// to vote for the candidate, since it is one of the args for the function vote()
	...
	struct Candidate {
		...
		// checks if this Struct exists
		// lets us keep track of candidates
		bool doesExist;
	}
